...
function validateBookingForm() {
    ...
    if (form.checkValidity()) {
        ...
        const whatsAppNumber = '919316432446';
        ...
        showSuccessPopup('Thank you! Please send the pre-filled message on WhatsApp to confirm your inquiry.');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    serviceGrid.addEventListener('click', (e) => {
        if (e.target.classList.contains('btn-whatsapp')) {
            ...
            const whatsAppNumber = '919316432446'; // Your WhatsApp number

            // Construct the message
            const message = `Hello Aarya Electrical Stamping,\nI am interested in ${serviceName}.\nPlease share details.`;
    ...
    if (requestSection) {
        requestSection.addEventListener('click', (e) => {
            ...
            const whatsAppNumber = '919316432446'; // Using the number from the footer
